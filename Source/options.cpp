...
GameplayOptions::GameplayOptions()
    ...
    , friendlyFire("Friendly Fire", OptionEntryFlags::CantChangeInMultiPlayer, N_("Friendly Fire"), N_("TURN THIS SETTING ON AT YOUR PERIL.  WILL ALSO ENABLE INVADER MODE.  WARNING: PLAYER DEATH AND ITEM LOSS IMMINENT"), false)
